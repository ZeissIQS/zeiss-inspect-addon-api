...
myst:
   html_meta:
      "description": "ZEISS INSPECT 2025 App Python API Specification - gom.Resource API"
...
For examples, see <a href="https://github.com/ZEISS/zeiss-inspect-app-examples/tree/main/AppExamples#script_resources--how-to-access-binary-data-of-your-app-resources">Examples of category `script_resources`</a>.
```
