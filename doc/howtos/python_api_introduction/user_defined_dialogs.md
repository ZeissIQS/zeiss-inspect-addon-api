...
* User defined **Dialogs** can be inserted into the script using _right mouse button_ → Insert → Dialog... in the [Add-on Editor](../using_add_on_editor/using_add_on_editor.html).
...
```{note}
The Dialog Editor is opened from the [Add-on Editor](../using_add_on_editor/using_add_on_editor.html) by
