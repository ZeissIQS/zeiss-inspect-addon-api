...
To learn about these mechanisms, you should take a look at the more sophisticated examples of our `Python API Examples` App, [documented here](../../python_examples/scripted_actuals.md).
