...
![Scripted circle element example](ex2_circle.png)

```{note}
This is an example for a scripted 'circle' element. Please see [offset_point_v2.md](offset_point_v2.md) for a complete example with detailed description.
```
