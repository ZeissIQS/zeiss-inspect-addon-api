...
![Scripted cone element example](ex6_cone.png)
...
```{note}
This is an example for a scripted 'cone' element. Please see [offset_point_v2.md](offset_point_v2.md) for a complete example with detailed description.
```
...
* [Scripted actuals circle](../../python_api/scripted_elements_api.md#cone)
