...
> Elements in the ZEISS INSPECT are represented by 'element references' in the script. These are Python expressions which, when executed, return a reference to that element.
